...
As currently written, this is removing any instance where a taxon has an abundance of <1% in a sample (its abundance is set to zero for that sample).
```{r}
library(qiime2R)
library(tidyverse)
library(biomformat)
...
But wait - should we redo the MiFish analysis to correct the 1% abundance filtering? Or should I adjust this to be the same as the MiFish filtering?

I think I am leaning towards adjusting this so that it reflects the MiFish filtering but I think I should think on it a little longer.